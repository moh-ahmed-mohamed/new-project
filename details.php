...
<body>
  ...
  if (isset($_GET['id'])) {
    $card_id = mysqli_real_escape_string($con, $_GET['id']); // Sanitize input
    ...
    if ($result) {
      ...
      if (mysqli_num_rows($result) == 1) {
        ...
        echo "
                ...
                <img src='image/$row[image]' class='img' >
                <p>$row[details]</p>
                <h1 dir='rtl'>$row[price]</h1>
                <h1><i class='icon fa-solid fa-location-dot'></i>$row[place]</h1>
